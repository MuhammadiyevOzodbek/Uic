                ...
                <div className="flex items-center pr-4 gap-4 text-[17px] whitespace-nowrap">
                  ...
                  {["EN", "RU", "UZ"].map((lang) => (
                    <span
                      ...
                      className={`cursor-pointer font-semibold transition ${language === lang ? "text-white" : "text-gray-400 hover:text-white"}`}>
                      {lang}
                    </span>
                  ))}
                </div>
